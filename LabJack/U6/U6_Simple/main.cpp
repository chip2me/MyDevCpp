...
//  Simple
//  
//  Basic UD U6 example for Dev-C++.  Demonstrates dynamic linking which
...
static int toggle;
	...
	while (1)
	{
	   //Execute the requests.
    	...
    	//Set digital output FIO1 to output-high.
        toggle=toggle^1;
	    lngErrorcode = m_pAddRequest (lngHandle, LJ_ioPUT_DIGITAL_BIT, 1, toggle, 0, 0);
    	ErrorHandler(lngErrorcode, __LINE__, 0);
        printf("FI01 = %d\n",toggle);
		...
		printf("AIN2 = %f\n",Value2);
  		printf("AIN3 = %f\n",Value3);
		printf("FIO0 = %f\n",ValueDIBit);
		printf("FIO2-FIO7 = %f\n",ValueDIPort);  //Will read 63 if all 6 lines are pulled-high as normal.
